...
@section('content')
  <!-- Horizontal Form -->
        ...
        <div class="form-group">
           ...
           <div class="col-sm-5">
           <input type="text" class="form-control" placeholder="Masukkan Jumlah" name="jumlah" value="{{$transaksiToko->jumlah}}">  {!! $errors-> first('jumlah', '<strong class="text-danger">:message</strong>')!!}
            </div>
        </div>
        </div>
